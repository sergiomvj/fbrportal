...
Reference full template: `C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/templates/state.md`.
