...
Use template from `C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/templates/UI-SPEC.md`
