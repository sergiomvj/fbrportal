...
```
Task(
  prompt="Read C:/Projetos/1FBRPortal/fbrportal/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/templates/SECURITY.md`
