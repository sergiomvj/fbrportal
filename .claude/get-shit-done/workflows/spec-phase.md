...
```bash
INIT=$(node "C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/templates/spec.md.
