...
<required_reading>
@C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/references/ai-frameworks.md
@C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Projetos/1FBRPortal/fbrportal/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Projetos/1FBRPortal/fbrportal/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Projetos/1FBRPortal/fbrportal/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Projetos/1FBRPortal/fbrportal/.claude/agents/gsd-eval-planner.md for instructions.
