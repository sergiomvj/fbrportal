...
```
Task(
  prompt="Read C:/Projetos/1FBRPortal/fbrportal/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/templates/VALIDATION.md`
