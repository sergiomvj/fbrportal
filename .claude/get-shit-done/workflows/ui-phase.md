...
```markdown
Read C:/Projetos/1FBRPortal/fbrportal/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Projetos/1FBRPortal/fbrportal/.claude/agents/gsd-ui-checker.md for instructions.
