...
```bash
INIT=$(node "C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
