...
INSTALL_JS_GLOBAL="C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
