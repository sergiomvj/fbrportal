...
<execution_context>
@C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/workflows/code-review.md
</execution_context>
...
Execute the code-review workflow from @C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/workflows/code-review.md end-to-end.
