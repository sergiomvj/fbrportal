...
<execution_context>
@C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @C:/Projetos/1FBRPortal/fbrportal/.claude/get-shit-done/workflows/docs-update.md end-to-end.
